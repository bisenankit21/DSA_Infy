...
public class HTechCollegeFestival {
	public static Set<Student> findUnique(List<Student> students) {
		//Implement your logic here and change the return statement accordingly 
		Set<Student> uniq=new HashSet<Student>();
		uniq.addAll(students);
		return uniq;
	}
	...
	public static Set<Student> findDuplicates(List<Student> students) {
		...
		Set<Student> duplicateList=new HashSet<Student>();
		for(Student std:students) {
			if(!newList.add(std)) {
				duplicateList.add(std);
			}
		}
