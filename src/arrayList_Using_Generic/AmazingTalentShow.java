...
public class AmazingTalentShow {
	...
	public static List<Participant> getFinalistsByTalent(List<Participant> finalists, String talent) {
		// Implement your logic here and change the return statement accordingly
		List<Participant> t=new ArrayList<Participant>();
		for(Participant x:finalists) {
			if(x.getParticipantTalent().equals(talent)) {
				t.add(x);
			}
		}
		return t;
